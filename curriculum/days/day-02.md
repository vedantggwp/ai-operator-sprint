...
There are 2 ways to use AI. Chatting: ask a question, get an answer, then do the work yourself with slightly better information. Delegating: hand over a task with a clear definition of done, check the result, keep the time. Same tool, different job description. The gap between them is most of the value.
...
Today you build the target list. The question is not "what can AI do". It is what do *you* do, repeatedly, that you could hand over. The writing you produce on a schedule. The lookups you repeat. The summaries, the reformatting, the first drafts, the thing you've been avoiding since March.

The honest, boring inventory of your own week is worth more than any prompt trick. Every automation you build in weeks 2 to 4 comes off this list. Operators don't start with the tool. They start with the work.
...
Today's artefact is your Delegation List. 10 real tasks from your real week (or an honest 6), each with the first instruction you'd give, saved in `AI-OS`.
...
- **The table still feels generic.** You answered in generalities, like "admin" or "emails". Re-answer one question with a specific example from the last 7 days and ask Claude to redo the table.
...
Add a fifth column: minutes per week each task costs you, then total it. That number is your baseline. Day 21 asks how many of those minutes you've won back. Skippable. The list is the artefact.
