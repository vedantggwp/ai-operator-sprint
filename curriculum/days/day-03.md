...
Ask a colleague for "an email about the deadline thing" and they fill the gaps themselves. They know the project, the reader, what happened last week. Claude can't. Every detail you leave out, it invents. And it invents averages: the middle-of-the-road email no real human would send.
...
Today's artefact is My Prompts v1: 5 reusable templates, 1 of them already proven against its lazy twin, saved in `AI-OS`.
